...
<div class="fiche">
			<div class="ficheGauche">ID Utilisateur 
					...
					<div id="prenom_util">
						Pr�nom : <input type="text" readonly="readonly" name="prenom" value="${utilisateur.prenom}"></input>
					</div>
					...
					<div id="tel_util">
						T�l�phone :<input type="text" readonly="readonly" name="tel" value="${utilisateur.tel}"></input>
					</div>
					<div id="mail_util">
